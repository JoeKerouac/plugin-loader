...
public class ExplodedArchive implements Archive {
     ...
     *            the root directory
     * @param recursive
     *            if recursive searching should be used to locate the manifest. Defaults to {@code true}, directories
     *            with a large tree might want to set this to {@code false}.
     */
    ...
    /**
     * {@link Archive} implementation backed by a simple JAR file that doesn't itself contain nested archives.
     */
