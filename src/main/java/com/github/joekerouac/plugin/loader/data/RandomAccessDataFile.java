...
public class RandomAccessDataFile implements RandomAccessData {
    ...
    private class DataInputStream extends InputStream {
         ...
         * 
         * @param b
         *            the bytes to read or {@code null} when reading a single byte
         * @param off
         *            the offset of the byte array
         * @param len
         *            the length of data to read
         * @return the number of bytes read into {@code b} or the actual read byte if {@code b} is {@code null}. Returns
