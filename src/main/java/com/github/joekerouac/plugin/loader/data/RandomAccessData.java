 ...
 */
package com.github.joekerouac.plugin.loader.data;
...
/**
 * Interface that provides read-only random access to some underlying data. Implementations must allow concurrent reads
...
public interface RandomAccessData {
    ...
    /**
     * Returns an {@link InputStream} that can be used to read the underlying data. The caller is responsible close the
     * underlying stream.
     * 
     ...
     *             if offset is beyond the end of the file or subsection
     * @throws EOFException
