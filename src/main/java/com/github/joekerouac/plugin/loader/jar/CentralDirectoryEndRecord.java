...
class CentralDirectoryEndRecord {
    ...
    /**
     * Create a new {@link CentralDirectoryEndRecord} instance from the specified {@link RandomAccessData}, searching
     * backwards from the end until a valid block is located.
     * 
     * @param data
     *            the source data
     * @throws IOException
    ...
    /**
     * Returns the location in the data that the archive actually starts. For most files the archive data will start at
     * 0, however, it is possible to have prefixed bytes (often used for startup scripts) at the beginning of the data.
     * 
     * @param data
     *            the source data
     ...
     *
     * @see <a href="https://pkware.cachefly.net/webdocs/casestudies/APPNOTE.TXT">Chapter 4.3.14 of Zip64
     *      specification</a>
     */
     ...
     *
     * @see <a href="https://pkware.cachefly.net/webdocs/casestudies/APPNOTE.TXT">Chapter 4.3.15 of Zip64
     *      specification</a>
     */
